...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, SeekBar.OnSeekBarChangeListener, LyricView.OnPlayerClickListener {
    ...
    public void onBufferingUpdate(MediaPlayer mediaPlayer, int i) {
        display_seek.setSecondaryProgress((int) (mediaPlayer.getDuration() * 1.00f * i / 100.0f));
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
        if (b) {
            DecimalFormat format = new DecimalFormat("00");
            display_position.setText(format.format(i / 1000 / 60) + ":" + format.format(i / 1000 % 60));
        }
    }
            ...
            switch (msg.what) {
                ...
                case MSG_LYRIC_SHOW:
                    try {
                        ...
                        mediaPlayer.setOnBufferingUpdateListener(Main2Activity.this);
